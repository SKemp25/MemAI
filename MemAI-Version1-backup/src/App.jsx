      ...
      <main className="main">
        ...
        {view === 'conversations' && !showAdd && !selected && (
          <div className="welcome">
            <h1>MemAI</h1>
            <p>Recall all that's important to you. Save chats from AI and content from life.</p>
            <p>Tap <strong>+ New</strong> to paste and save. Everything stays on this device.</p>
          </div>
        )}
      </main>
    </div>
